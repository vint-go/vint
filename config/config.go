...
import (
	...
	"github.com/vint-go/vint/formatter"
	"github.com/vint-go/vint/lint"
	"github.com/vint-go/vint/rule"
	"github.com/vint-go/vint/rules/no_address_nil_comparison"
	"github.com/vint-go/vint/rules/no_address_of_dereference"
	...
	"github.com/vint-go/vint/rules/no_bad_lock_pattern"
	"github.com/vint-go/vint/rules/no_bad_regexp_pattern"
	...
	"github.com/vint-go/vint/rules/no_commented_out_code"
	...
	"github.com/vint-go/vint/rules/no_confusing_results"
	...
	"github.com/vint-go/vint/rules/no_defer_gotcha"
	...
	"github.com/vint-go/vint/rules/no_denied_import"
	...
	"github.com/vint-go/vint/rules/no_doc_comment_stub"
	"github.com/vint-go/vint/rules/no_dot_import"
	...
	"github.com/vint-go/vint/rules/no_duplicate_import"
	...
	"github.com/vint-go/vint/rules/no_excessive_file_length"
	...
	"github.com/vint-go/vint/rules/no_flag_deref_before_parse"
	...
	"github.com/vint-go/vint/rules/no_http_client_get"
	...
	"github.com/vint-go/vint/rules/no_ineffective_rand_call"
	...
	"github.com/vint-go/vint/rules/no_invalid_exec_command_arg"
	...
	"github.com/vint-go/vint/rules/no_invalid_strconv_arg"
	...
	"github.com/vint-go/vint/rules/no_log_injection_taint"
	...
	"github.com/vint-go/vint/rules/no_magic_number_in_argument"
	"github.com/vint-go/vint/rules/no_magic_number_in_assignment"
	"github.com/vint-go/vint/rules/no_magic_number_in_case"
	"github.com/vint-go/vint/rules/no_magic_number_in_condition"
	...
	"github.com/vint-go/vint/rules/no_modified_value_receiver"
	"github.com/vint-go/vint/rules/no_modulo_one"
	...
	"github.com/vint-go/vint/rules/no_net_listen"
	"github.com/vint-go/vint/rules/no_net_listen_packet"
	"github.com/vint-go/vint/rules/no_net_lookup_addr"
	"github.com/vint-go/vint/rules/no_net_lookup_cname"
	"github.com/vint-go/vint/rules/no_net_lookup_host"
	...
	"github.com/vint-go/vint/rules/no_net_lookup_txt"
	...
	"github.com/vint-go/vint/rules/no_permissive_write_file_permissions"
	...
	"github.com/vint-go/vint/rules/no_redundant_canonical_header_key"
	...
	"github.com/vint-go/vint/rules/no_redundant_nil_loop_check"
	...
	"github.com/vint-go/vint/rules/no_repeated_strings"
	...
	"github.com/vint-go/vint/rules/no_separator_in_filepath_join"
	...
	"github.com/vint-go/vint/rules/no_slog_key_value_mismatch"
	...
	"github.com/vint-go/vint/rules/no_sql_db_exec"
	...
	"github.com/vint-go/vint/rules/no_strings_compare"
	...
	"github.com/vint-go/vint/rules/no_test_main_without_exit"
	...
	"github.com/vint-go/vint/rules/no_tls_dial_with_dialer"
	...
	"github.com/vint-go/vint/rules/no_unmarshalable_struct"
	"github.com/vint-go/vint/rules/no_unmarshalable_type"
	"github.com/vint-go/vint/rules/no_unnecessary_blank_identifier"
	"github.com/vint-go/vint/rules/no_unnecessary_block"
	"github.com/vint-go/vint/rules/no_unnecessary_conversion"
	...
	"github.com/vint-go/vint/rules/no_unnecessary_format"
	"github.com/vint-go/vint/rules/no_unnecessary_if"
	"github.com/vint-go/vint/rules/no_unnecessary_lambda"
	"github.com/vint-go/vint/rules/no_unnecessary_loop_var_copy"
	"github.com/vint-go/vint/rules/no_unnecessary_stmt"
	...
	"github.com/vint-go/vint/rules/no_unsigned_negative_comparison"
	...
	"github.com/vint-go/vint/rules/no_unused_receiver"
	"github.com/vint-go/vint/rules/no_unused_type"
	"github.com/vint-go/vint/rules/no_unused_variable"
	...
	"github.com/vint-go/vint/rules/no_wait_group_misuse"
	...
	"github.com/vint-go/vint/rules/no_xss_taint"
	...
	"github.com/vint-go/vint/rules/use_compiled_regexp"
	"github.com/vint-go/vint/rules/use_consistent_receiver_name"
	"github.com/vint-go/vint/rules/use_context_as_first_param"
	"github.com/vint-go/vint/rules/use_convenience_func"
	"github.com/vint-go/vint/rules/use_copy_builtin"
	"github.com/vint-go/vint/rules/use_copy_for_slide"
	...
	"github.com/vint-go/vint/rules/use_exported_comment"
	"github.com/vint-go/vint/rules/use_file_header"
	"github.com/vint-go/vint/rules/use_filename_format"
	"github.com/vint-go/vint/rules/use_filepath_join"
	...
	"github.com/vint-go/vint/rules/use_idiomatic_error_name"
	"github.com/vint-go/vint/rules/use_idiomatic_naming"
	"github.com/vint-go/vint/rules/use_idiomatic_receiver_name"
	"github.com/vint-go/vint/rules/use_import_alias_naming"
	...
	"github.com/vint-go/vint/rules/use_optimal_field_alignment"
	...
	"github.com/vint-go/vint/rules/use_repeated_arg_type_style"
	...
	"github.com/vint-go/vint/rules/use_simplified_print_format"
	...
	"github.com/vint-go/vint/rules/use_time_method"
	"github.com/vint-go/vint/rules/use_time_naming"
	"github.com/vint-go/vint/rules/use_time_since"
	...
	"github.com/vint-go/vint/rules/use_type_assert_result"
