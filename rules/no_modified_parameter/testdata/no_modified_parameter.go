...
func testSlicesDeleteAssigned(s []int) {
	s = slices.Delete(s, 0, 1) /* MATCH /parameter 's' seems to be modified/ */ // MATCH /parameter 's' seems to be modified by 'slices.Delete'/
	s = slices.DeleteFunc(s, func(e string) bool { return true }) /* MATCH /parameter 's' seems to be modified/ */ // MATCH /parameter 's' seems to be modified by 'slices.DeleteFunc'/
	...
	s, b := slices.Delete(s, 0, 1), 2 /* MATCH /parameter 's' seems to be modified/ */ // MATCH /parameter 's' seems to be modified by 'slices.Delete'/
...
func testMultipleParams(a, b, s []int) {
	a = slices.Delete(a, 0, 1) /* MATCH /parameter 'a' seems to be modified/ */ // MATCH /parameter 'a' seems to be modified by 'slices.Delete'/
	b = slices.Delete(b, 1, 2) /* MATCH /parameter 'b' seems to be modified/ */ // MATCH /parameter 'b' seems to be modified by 'slices.Delete'/
