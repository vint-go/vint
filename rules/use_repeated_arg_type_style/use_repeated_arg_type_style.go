package use_repeated_arg_type_style
...
func (*EnforceRepeatedArgTypeStyleRule) Name() string {
	return "useRepeatedArgTypeStyle"
}

// Group returns the group this rule belongs to.
func (*EnforceRepeatedArgTypeStyleRule) Group() string {
	return "style"
}
