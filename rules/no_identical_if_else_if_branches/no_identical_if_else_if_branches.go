package no_identical_if_else_if_branches
...
func (*IdenticalIfElseIfBranchesRule) Name() string {
	return "noIdenticalIfElseIfBranches"
}

// Group returns the rule group.
func (*IdenticalIfElseIfBranchesRule) Group() string {
	return "suspicious"
}
...
func (*IdenticalIfElseIfBranchesRule) CacheTier() rulecache.CacheTier {
