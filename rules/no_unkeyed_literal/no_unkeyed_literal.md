...
Using keyed literals makes code more readable and robust against changes to the struct definition. This check applies to struct types from external packages by default.
