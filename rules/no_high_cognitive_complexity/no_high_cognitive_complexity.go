package no_high_cognitive_complexity
...
// NoHighCognitiveComplexityRule sets restriction for maximum cognitive complexity.
type NoHighCognitiveComplexityRule struct {
	maxComplexity int
}
...
func (r *NoHighCognitiveComplexityRule) Configure(arguments lint.Arguments) error {
	if len(arguments) < 1 {
...
func (r *NoHighCognitiveComplexityRule) Apply(file *lint.File, _ lint.Arguments) []lint.Failure {
...
func (*NoHighCognitiveComplexityRule) Name() string {
	return "noHighCognitiveComplexity"
}

// Group returns the rule group.
func (*NoHighCognitiveComplexityRule) Group() string {
	return "complexity"
}
...
func (*NoHighCognitiveComplexityRule) CacheTier() rulecache.CacheTier {
