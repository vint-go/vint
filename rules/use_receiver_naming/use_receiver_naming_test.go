...
func TestReceiverNamingRule_Configure(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr:   errors.New("unable to get arguments for rule useReceiverNaming. Expected object of key-value-pairs"),
		},
		{
		...
		},
		{
			...
			wantErr: errors.New("invalid value 10 for argument maxLength of rule useReceiverNaming, expected integer value got string"),
		},
		{
			...
			wantErr: errors.New("unknown argument unknownKey for useReceiverNaming rule"),
		},
	}
