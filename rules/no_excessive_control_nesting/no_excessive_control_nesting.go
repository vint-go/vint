package no_excessive_control_nesting
...
func (*MaxControlNestingRule) Name() string {
	return "noExcessiveControlNesting"
}

// Group returns the rule group.
func (*MaxControlNestingRule) Group() string {
	return "complexity"
}
...
func (r *MaxControlNestingRule) Configure(arguments lint.Arguments) error {
	...
	maxNesting, ok := lint.ToInt64(arguments[0])
	if !ok {
		return errors.New(`invalid value passed as argument number to the "noExcessiveControlNesting" rule`)
	}
	r.max = maxNesting
	return nil
}
